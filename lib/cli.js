...
cli
  ...
  .option('-s, --query_size [n]', 'Query size for scroll', coerceInt)
  .option('-q, --query_body [value]', 'Query to perform', coerceObj)
  .option('-d, --scroll_duration [value]', 'Length of time to cache scroll', /^\d{1,2}[sm]$/)
  .option('-r, --scroll_retries [n]', 'Number of scroll retries', coerceInt)
